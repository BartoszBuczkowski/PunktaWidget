...
export declare type CarDataFields = Record<FormField["id"], AutocompleteValues | null>;
...
export declare type SearchAttributesKeys = keyof typeof searchAttributes;
//# sourceMappingURL=PunktaWidget.types.d.ts.map